  ...
  return (
    ...
    <form onSubmit={handleSubmit}  enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div className="col">
                <input type="text" name="mau_sac" onChange={handleInputChange} value={mau_sac} className="form-control" placeholder="Đơn vị"/>
            </div>

        </div>
        <div className='row mb-3'>
        <div className="col">
                <input type="text" name="kich_co" onChange={handleInputChange} value={kich_co} className="form-control" placeholder="Đơn giá"/>
            </div>
            <div class="col">
