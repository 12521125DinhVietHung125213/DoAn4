    ...
    <div id="polyclinic-story">
      <section className="cs-banner">
        <div className="cs-banner__image">
          <img src="../Images/10290729.jpg" alt="" />
        </div>
        <div className="cs-banner__content">
          {/* <h1 style={{ color: 'black' }} className="cs-banner__heading">Câu chuyện về Phòng khám</h1>
          <p style={{ color: 'black' }} className="cs-banner__description">
            Đây là chuyên mục giúp bạn biết được phòng khám đã hình thành ra sao và chúng tôi muốn xây dựng một cơ sở y tế như thế nào!
          </p> */}
        </div>
      </section>
