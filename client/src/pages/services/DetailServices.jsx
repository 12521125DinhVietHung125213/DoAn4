...
export default function Details() {
  ...
  return (
    ...
    <h4>Tiền sử bệnh lý và khám lâm sàng:</h4>
    <ul>
        <li>Hỏi bệnh sử cá nhân và gia đình: Để phát hiện các yếu tố nguy cơ di truyền.</li>
        <li>Kiểm tra các chỉ số sinh tồn: Bao gồm chiều cao, cân nặng, huyết áp, nhịp tim, chỉ số BMI.</li>
        <li>Khám tổng quát: Kiểm tra các hệ cơ bản như hệ hô hấp, hệ tiêu hóa, hệ tim mạch, và hệ thần kinh.</li>
    </ul>

    <h4>Xét nghiệm máu và nước tiểu:</h4>
    <ul>
        <li>Công thức máu: Để kiểm tra tình trạng thiếu máu, số lượng bạch cầu, hồng cầu.</li>
        <li>Xét nghiệm đường huyết và mỡ máu: Kiểm tra glucose máu, cholesterol, LDL, HDL để đánh giá nguy cơ bệnh tim mạch và tiểu đường.</li>
        <li>Xét nghiệm chức năng gan, thận: Bao gồm các chỉ số như ALT, AST, creatinine, urea.</li>
        <li>Xét nghiệm nước tiểu: Kiểm tra sự hiện diện của protein, glucose, hồng cầu, và các dấu hiệu nhiễm trùng.</li>
    </ul>

    <h4>Xét nghiệm viêm nhiễm và các bệnh nam khoa:</h4>
    <ul>
        <li>Xét nghiệm các bệnh lây truyền qua đường tình dục (nếu có nguy cơ): Bao gồm các xét nghiệm cho HIV, viêm gan B/C, giang mai, v.v.</li>
        <li>Kiểm tra tuyến tiền liệt (đối với nam giới trên 40 tuổi hoặc có yếu tố nguy cơ): Xét nghiệm PSA (kháng nguyên đặc hiệu của tuyến tiền liệt) giúp đánh giá sức khỏe của tuyến tiền liệt.</li>
    </ul>

    <h4>Các kiểm tra hình ảnh:</h4>
    <ul>
        <li>Siêu âm ổ bụng: Đánh giá các cơ quan nội tạng như gan, mật, thận, tụy, và lách.</li>
        <li>Chụp X-quang ngực: Kiểm tra phổi và tim.</li>
        <li>Siêu âm tim (nếu cần): Đánh giá hoạt động của tim.</li>
    </ul>

    <h4>Đánh giá sức khỏe tâm lý và lối sống:</h4>
    <ul>
        <li>Đánh giá sức khỏe tâm lý và các thói quen sinh hoạt như hút thuốc, uống rượu, chế độ ăn uống, vận động.</li>
        <li>Đưa ra các lời khuyên về dinh dưỡng, tập thể dục, và giảm nguy cơ bệnh.</li>
    </ul>

    <img src="/images/chitietsk.jpg" alt="Chi tiết dịch vụ"/>
</div>
